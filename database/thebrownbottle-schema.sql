...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `thebrownbottle`.`employee` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `thebrownbottle`.`shift` ;
...
-- -----------------------------------------------------
-- Table `thebrownbottle`.`schedule`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `thebrownbottle`.`schedule` ;

CREATE TABLE IF NOT EXISTS `thebrownbottle`.`schedule` (
  `schedule_id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `employee_id` INT UNSIGNED NOT NULL,
  `shift_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`schedule_id`, `employee_id`, `shift_id`),
  UNIQUE INDEX `schedule_id_UNIQUE` (`employee_id` ASC) VISIBLE,
  UNIQUE INDEX `employee_id_UNIQUE` (`schedule_id` ASC) VISIBLE,
  UNIQUE INDEX `shift_id_UNIQUE` (`shift_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `thebrownbottle`.`role` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `thebrownbottle`.`section` ;
...
-- -----------------------------------------------------
-- Table `thebrownbottle`.`avalibility`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `thebrownbottle`.`avalibility` ;

CREATE TABLE IF NOT EXISTS `thebrownbottle`.`avalibility` (
  `avalibility_id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `employee_id` INT UNSIGNED NOT NULL,
  `day_of_week` ENUM('Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday') NOT NULL,
  `status` ENUM('Pending', 'Approved', 'Denied') NOT NULL,
  PRIMARY KEY (`avalibility_id`, `employee_id`),
  UNIQUE INDEX `avalibility_id_UNIQUE` (`avalibility_id` ASC) VISIBLE,
  UNIQUE INDEX `employee_id_UNIQUE` (`employee_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `thebrownbottle`.`time_off_request` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `thebrownbottle`.`shift_cover_request` ;
...
CREATE TABLE IF NOT EXISTS `thebrownbottle`.`shift_cover_request` (
  ...
  `status` ENUM('Pending', 'Accepted', 'Denied') NOT NULL,
  PRIMARY KEY (`cover_request_id`, `accepted_employee_id`, `shift_id`, `requested_employee_id`),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `thebrownbottle`.`attendance` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `thebrownbottle`.`chat` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `thebrownbottle`.`permissions` ;
...
CREATE TABLE IF NOT EXISTS `thebrownbottle`.`permissions` (
  ...
  `can_read` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0,
...
-- -----------------------------------------------------
-- Table `thebrownbottle`.`anncouncement`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `thebrownbottle`.`anncouncement` ;

CREATE TABLE IF NOT EXISTS `thebrownbottle`.`anncouncement` (
  `anncouncement_id` INT NOT NULL AUTO_INCREMENT,
  `employee_id` INT UNSIGNED NOT NULL,
  `timestamp` TIMESTAMP NOT NULL,
  `title` VARCHAR(100) NOT NULL,
  `description` TEXT NOT NULL,
  PRIMARY KEY (`anncouncement_id`, `employee_id`),
  UNIQUE INDEX `employee_id_UNIQUE` (`employee_id` ASC) VISIBLE,
  UNIQUE INDEX `anncouncement_id_UNIQUE` (`anncouncement_id` ASC) VISIBLE,
