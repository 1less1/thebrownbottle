  ...
  return (
    <DefaultView>
      ...
      <View style={{ margin: 20, width: '90%' }}>
        <Text style={{ textAlign: 'left', fontSize: 16, color: 'black' }}>Today</Text>

        {/* Clock In Card */}
        <Card style={{ backgroundColor: Colors.darkTan, width: '100%' }}>
          <Text style={{ textAlign: 'center', fontSize: 40, color: 'black', fontWeight: 'bold' }}>
            12:57pm
          </Text>
      ...
      <View style={{ width: '90%' }}>
        <Text style={{ textAlign: 'left', fontSize: 16, color: 'black' }}>Announcements</Text>

        {/* Announcements Container */}
        <Card style={{ backgroundColor: Colors.darkTan, paddingHorizontal: 10 }}>
          {/* Individual Announcement Items */}
          <Card style={{ backgroundColor: Colors.lightTan, width: '90%' }}>
            <Text>thebrownbottle.com is prone to IDOR. #normalizecybercriminals</Text>
          </Card>

          <Card style={{ backgroundColor: Colors.lightTan, width: '90%', marginTop: 6 }}>
